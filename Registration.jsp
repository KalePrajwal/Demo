			...
			<form action="Create" method="post">
				...
				<div class="input-name">
					<i class="fa fa-envelope lock"></i> <input type="useremail"
						name="useremail" placeholder="Email ID" class="form-control">
					<br>
				</div>

				<div class="input-name">
					<i class="fa fa-map-marker"></i> <input type="text" name="usercity"
						placeholder="Enter City" class="form-control" required> <br>
				</div>

				<div class="input-name">
					<i class="fa fa-mobile lock"></i> <input type="text"
						name="usermob" placeholder="Mobile NO" autocomplete="off"
						class="form-control"> <br>
				</div>
